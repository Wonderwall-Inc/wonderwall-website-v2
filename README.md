...
This is the official repository for the Golfin v4 website. The tech stack is as follows:

Frontend/Backend: PayloadCMS/NextJS, TypeScript
Database: Supabase PostgreSQL instance

## Quick Start

To spin up this repository locally, follow these steps:
...
This repository is configured in the following ways:
...
If you have any issues or questions, reach out to Tyler Greulich or Nishikawa-san on Slack.
